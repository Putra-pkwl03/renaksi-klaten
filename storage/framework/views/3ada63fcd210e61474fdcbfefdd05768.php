    ...
    <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
        <div class="col-xxl-3 col-lg-5 col-md-6">
            ...
            <div class="card overflow-hidden text-center p-xxl-4 p-3 mb-0">
                ...
                <form action="<?php echo e(url('/auth/register')); ?>" method="POST" class="text-start mb-3">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                ...
                <p class="text-nuted fs-14 mb-0">Already have an account? <a href="<?php echo e(route ('second' , ['auth','login'])); ?>"
...
<?php echo $__env->make('layouts.base', ['title' => 'Sign Up'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Adminto-Laravel_v2.0\Adminto\resources\views/auth/register.blade.php ENDPATH**/ ?>