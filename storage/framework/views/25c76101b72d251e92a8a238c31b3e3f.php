        ...
        <form action="<?php echo e(isset($laporan->id) ? route('laporan-renaksi.update', $laporan->id) : route('laporan-renaksi.store')); ?>" method="POST">
            ...
            <div class="row g-3">
                <?php $__currentLoopData = ['1','2','3','4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Target TW <?php echo e($tw); ?></label>
            ...
            <div class="row g-3 mt-2">
                <?php $__currentLoopData = ['1','2','3','4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Realisasi TW <?php echo e($tw); ?></label>
...
<?php /**PATH C:\laragon\www\Adminto-Laravel_v2.0\Adminto\resources\views/apps/LaporanRenaksiForm.blade.php ENDPATH**/ ?>